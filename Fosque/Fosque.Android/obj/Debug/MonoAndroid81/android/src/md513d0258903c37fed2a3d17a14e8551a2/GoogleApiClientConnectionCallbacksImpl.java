...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Android.Gms.Common.Apis.GoogleApiClientConnectionCallbacksImpl, Xamarin.GooglePlayServices.Basement", GoogleApiClientConnectionCallbacksImpl.class, __md_methods);
	}
	...
	public GoogleApiClientConnectionCallbacksImpl ()
	{
		...
		if (getClass () == GoogleApiClientConnectionCallbacksImpl.class)
			mono.android.TypeManager.Activate ("Android.Gms.Common.Apis.GoogleApiClientConnectionCallbacksImpl, Xamarin.GooglePlayServices.Basement", "", this, new java.lang.Object[] {  });
	}

...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Android.Gms.Common.Apis.GoogleApiClientOnConnectionFailedListenerImpl, Xamarin.GooglePlayServices.Basement", GoogleApiClientOnConnectionFailedListenerImpl.class, __md_methods);
	}
	...
	public GoogleApiClientOnConnectionFailedListenerImpl ()
	{
		...
		if (getClass () == GoogleApiClientOnConnectionFailedListenerImpl.class)
			mono.android.TypeManager.Activate ("Android.Gms.Common.Apis.GoogleApiClientOnConnectionFailedListenerImpl, Xamarin.GooglePlayServices.Basement", "", this, new java.lang.Object[] {  });
	}
